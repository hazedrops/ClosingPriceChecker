...
sql4 = "CREATE TABLE IF NOT EXISTS price_info (ID int AUTO_INCREMENT PRIMARY KEY, Ticker VARCHAR(255), Company VARCHAR(255), first_close FLOAT(4), last_close FLOAT(4), dec_percent FLOAT(4));"
sql5 = "CREATE TABLE IF NOT EXISTS nasdaq_price_info (ID int AUTO_INCREMENT PRIMARY KEY, Ticker VARCHAR(255), Company VARCHAR(255), first_close FLOAT(4), last_close FLOAT(4), dec_percent FLOAT(4));"
